...
4.) before checking, read the spec files listed below to get more context (eg. tech stack, features) to get the intention for code.
4.1.) /specs/main.md
4.2.) /specs/erd.md
4.3.) /specs/spacetimedb.md
4.4.) /specs/spacetimedb-typescript.md
5.) update specs/state.md if necessary after checking the codebase
6.) do not implement, let the user implement
