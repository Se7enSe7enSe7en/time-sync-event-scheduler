...
import AvailabilityRow from "./availability_table";
...
const tablesSchema = __schema({
  availability: __table({
    name: 'availability',
    indexes: [
      { name: 'id', algorithm: 'btree', columns: [
        'id',
      ] },
      { name: 'availability_profile_id', algorithm: 'btree', columns: [
        'profileId',
      ] },
    ],
    constraints: [
      { name: 'availability_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, AvailabilityRow),
  event: __table({
    name: 'event',
  ...
  group: __table({
    ...
    indexes: [
      ...
      { name: 'group_owner_id', algorithm: 'btree', columns: [
        'ownerId',
      ] },
    ],
    constraints: [
  ...
  groupMember: __table({
    name: 'group_member',
    indexes: [
      { name: 'group_member_group_profile_id', algorithm: 'btree', columns: [
        'groupId',
        'profileId',
      ] },
      { name: 'id', algorithm: 'btree', columns: [
